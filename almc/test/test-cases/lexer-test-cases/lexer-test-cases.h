...
inline void lexer_lexeme_test()
{
	...
	assert(tokens[54]->type == TOKEN_KEYWORD_CAST);
	...
	assert(tokens[73]->type == TOKEN_KEYWORD_INTRINSIC);
	...
	assert(tokens[80]->type == TOKEN_KEYWORD_UNION);
	assert(tokens[81]->type == TOKEN_KEYWORD_UINT8);
	assert(tokens[82]->type == TOKEN_KEYWORD_UINT16);
	assert(tokens[83]->type == TOKEN_KEYWORD_UINT32);
	assert(tokens[84]->type == TOKEN_KEYWORD_UINT64);
	assert(tokens[85]->type == TOKEN_KEYWORD_LET);
	assert(tokens[86]->type == TOKEN_KEYWORD_LABEL);
	assert(tokens[87]->type == TOKEN_KEYWORD_LENGTHOF);
	assert(tokens[88]->type == TOKEN_KEYWORD_VOID);
	assert(tokens[89]->type == TOKEN_KEYWORD_WHILE);
	assert(tokens[90]->type == TOKEN_KEYWORD_DO);
	assert(tokens[91]->type == TOKEN_KEYWORD_ELSE);
	lexer_free(lexer);
}
