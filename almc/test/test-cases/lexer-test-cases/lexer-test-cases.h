...
inline void lexer_lexeme_test()
{
	...
	assert(tokens[66]->type == TOKEN_KEYWORD_FORWARD);
	assert(tokens[67]->type == TOKEN_KEYWORD_GOTO);
	assert(tokens[68]->type == TOKEN_KEYWORD_IF);
	assert(tokens[69]->type == TOKEN_KEYWORD_INT8);
	assert(tokens[70]->type == TOKEN_KEYWORD_INT16);
	assert(tokens[71]->type == TOKEN_KEYWORD_INT32);
	assert(tokens[72]->type == TOKEN_KEYWORD_INT64);
	assert(tokens[73]->type == TOKEN_KEYWORD_IMPORT);
	assert(tokens[74]->type == TOKEN_KEYWORD_INTRINSIC);
	assert(tokens[75]->type == TOKEN_KEYWORD_REGISTER);
	assert(tokens[76]->type == TOKEN_KEYWORD_RETURN);
	assert(tokens[77]->type == TOKEN_KEYWORD_STRING);
	assert(tokens[78]->type == TOKEN_KEYWORD_STATIC);
	assert(tokens[79]->type == TOKEN_KEYWORD_STRUCT);
	assert(tokens[80]->type == TOKEN_KEYWORD_SWITCH);
	assert(tokens[81]->type == TOKEN_KEYWORD_SIZEOF);
	assert(tokens[82]->type == TOKEN_KEYWORD_TRUE);
	assert(tokens[83]->type == TOKEN_KEYWORD_TYPEOF);
	assert(tokens[84]->type == TOKEN_KEYWORD_UNION);
	assert(tokens[85]->type == TOKEN_KEYWORD_UINT8);
	assert(tokens[86]->type == TOKEN_KEYWORD_UINT16);
	assert(tokens[87]->type == TOKEN_KEYWORD_UINT32);
	assert(tokens[88]->type == TOKEN_KEYWORD_UINT64);
	assert(tokens[89]->type == TOKEN_KEYWORD_LET);
	assert(tokens[90]->type == TOKEN_KEYWORD_LABEL);
	assert(tokens[91]->type == TOKEN_KEYWORD_VOID);
	assert(tokens[92]->type == TOKEN_KEYWORD_VOLATILE);
	assert(tokens[93]->type == TOKEN_KEYWORD_WHILE);
	assert(tokens[94]->type == TOKEN_KEYWORD_DO);
	assert(tokens[95]->type == TOKEN_KEYWORD_ELSE);
	lexer_free(lexer);
}
