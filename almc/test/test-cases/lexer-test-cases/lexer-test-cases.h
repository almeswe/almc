...
inline void lexer_lexeme_test()
{
	...
	assert(tokens[67]->type == TOKEN_KEYWORD_IMPORT);
	assert(tokens[68]->type == TOKEN_KEYWORD_REGISTER);
	assert(tokens[69]->type == TOKEN_KEYWORD_RETURN);
	assert(tokens[70]->type == TOKEN_KEYWORD_STRING);
	assert(tokens[71]->type == TOKEN_KEYWORD_STATIC);
	assert(tokens[72]->type == TOKEN_KEYWORD_STRUCT);
	assert(tokens[73]->type == TOKEN_KEYWORD_SWITCH);
	assert(tokens[74]->type == TOKEN_KEYWORD_SIZEOF);
	assert(tokens[75]->type == TOKEN_KEYWORD_TRUE);
	assert(tokens[76]->type == TOKEN_KEYWORD_TYPEOF);
	...
	assert(tokens[84]->type == TOKEN_KEYWORD_VOID);
	assert(tokens[85]->type == TOKEN_KEYWORD_VOLATILE);
	assert(tokens[86]->type == TOKEN_KEYWORD_WHILE);
	assert(tokens[87]->type == TOKEN_KEYWORD_DO);
	assert(tokens[88]->type == TOKEN_KEYWORD_ELSE);
	lexer_free(lexer);
}
