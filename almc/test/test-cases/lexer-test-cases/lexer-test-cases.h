...
inline void lexer_lexeme_test()
{
	...
	assert(tokens[48]->type == TOKEN_KEYWORD_AUTO);
	assert(tokens[49]->type == TOKEN_KEYWORD_BREAK);
	assert(tokens[50]->type == TOKEN_KEYWORD_CASE);
	assert(tokens[51]->type == TOKEN_KEYWORD_CHAR);
	assert(tokens[52]->type == TOKEN_KEYWORD_CAST);
	assert(tokens[53]->type == TOKEN_KEYWORD_CONTINUE);
	assert(tokens[54]->type == TOKEN_KEYWORD_DEFAULT);
	assert(tokens[55]->type == TOKEN_KEYWORD_ENUM);
	assert(tokens[56]->type == TOKEN_KEYWORD_ELIF);
	assert(tokens[57]->type == TOKEN_KEYWORD_ENTRY);
	assert(tokens[58]->type == TOKEN_KEYWORD_FOR);
	assert(tokens[59]->type == TOKEN_KEYWORD_FUNC);
	assert(tokens[60]->type == TOKEN_KEYWORD_FROM);
	assert(tokens[61]->type == TOKEN_KEYWORD_FALSE);
	assert(tokens[62]->type == TOKEN_KEYWORD_FLOAT32);
	assert(tokens[63]->type == TOKEN_KEYWORD_FLOAT64);
	assert(tokens[64]->type == TOKEN_KEYWORD_GOTO);
	assert(tokens[65]->type == TOKEN_KEYWORD_IF);
	assert(tokens[66]->type == TOKEN_KEYWORD_INT8);
	assert(tokens[67]->type == TOKEN_KEYWORD_INT16);
	assert(tokens[68]->type == TOKEN_KEYWORD_INT32);
	assert(tokens[69]->type == TOKEN_KEYWORD_INT64);
	assert(tokens[70]->type == TOKEN_KEYWORD_IMPORT);
	assert(tokens[71]->type == TOKEN_KEYWORD_INTRINSIC);
	assert(tokens[72]->type == TOKEN_KEYWORD_RETURN);
	assert(tokens[73]->type == TOKEN_KEYWORD_STRING);
	assert(tokens[74]->type == TOKEN_KEYWORD_STRUCT);
	assert(tokens[75]->type == TOKEN_KEYWORD_SWITCH);
	assert(tokens[76]->type == TOKEN_KEYWORD_SIZEOF);
	assert(tokens[77]->type == TOKEN_KEYWORD_TRUE);
	assert(tokens[78]->type == TOKEN_KEYWORD_UNION);
	assert(tokens[79]->type == TOKEN_KEYWORD_UINT8);
	assert(tokens[80]->type == TOKEN_KEYWORD_UINT16);
	assert(tokens[81]->type == TOKEN_KEYWORD_UINT32);
	assert(tokens[82]->type == TOKEN_KEYWORD_UINT64);
	assert(tokens[83]->type == TOKEN_KEYWORD_LET);
	assert(tokens[84]->type == TOKEN_KEYWORD_LABEL);
	assert(tokens[85]->type == TOKEN_KEYWORD_LENGTHOF);
